...
},type,chainable?margin:void 0,chainable,null)}})}),jQuery.fn.size=function(){return this.length},jQuery.fn.andSelf=jQuery.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return jQuery});var _jQuery=window.jQuery,_$=window.$;return jQuery.noConflict=function(deep){return window.$===jQuery&&(window.$=_$),deep&&window.jQuery===jQuery&&(window.jQuery=_jQuery),jQuery},typeof noGlobal===strundefined&&(window.jQuery=window.$=jQuery),jQuery}),GridSampler={checkAndNudgePoints:function(d,a){for(var c=qrcode.width,b=qrcode.height,e=!0,g=0;g<a.Length&&e;g+=2){var f=Math.floor(a[g]),h=Math.floor(a[g+1]);if(-1>f||f>c||-1>h||h>b)throw"Error.checkAndNudgePoints ";e=!1,-1==f?(a[g]=0,e=!0):f==c&&(a[g]=c-1,e=!0),-1==h?(a[g+1]=0,e=!0):h==b&&(a[g+1]=b-1,e=!0)}for(e=!0,g=a.Length-2;g>=0&&e;g-=2){if(f=Math.floor(a[g]),h=Math.floor(a[g+1]),-1>f||f>c||-1>h||h>b)throw"Error.checkAndNudgePoints ";e=!1,-1==f?(a[g]=0,e=!0):f==c&&(a[g]=c-1,e=!0),-1==h?(a[g+1]=0,e=!0):h==b&&(a[g+1]=b-1,e=!0)}},sampleGrid3:function(d,a,c){for(var b=new BitMatrix(a),e=Array(a<<1),g=0;a>g;g++){for(var f=e.length,h=g+.5,j=0;f>j;j+=2)e[j]=(j>>1)+.5,e[j+1]=h;c.transformPoints1(e),GridSampler.checkAndNudgePoints(d,e);try{for(j=0;f>j;j+=2){var k=4*Math.floor(e[j])+4*Math.floor(e[j+1])*qrcode.width,n=d[Math.floor(e[j])+qrcode.width*Math.floor(e[j+1])];qrcode.imagedata.data[k]=n?255:0,qrcode.imagedata.data[k+1]=n?255:0,qrcode.imagedata.data[k+2]=0,qrcode.imagedata.data[k+3]=255,n&&b.set_Renamed(j>>1,g)}}catch(l){throw"Error.checkAndNudgePoints"}}return b},sampleGridx:function(d,a,c,b,e,g,f,h,j,k,n,l,s,r,m,q,x,y){return c=PerspectiveTransform.quadrilateralToQuadrilateral(c,b,e,g,f,h,j,k,n,l,s,r,m,q,x,y),GridSampler.sampleGrid3(d,a,c)}},Version.VERSION_DECODE_INFO=[31892,34236,39577,42195,48118,51042,55367,58893,63784,68472,70749,76311,79154,84390,87683,92361,96236,102084,102881,110507,110734,117786,119615,126325,127568,133589,136944,141498,145311,150283,152622,158308,161089,167017],Version.VERSIONS=buildVersions(),Version.getVersionForNumber=function(d){if(1>d||d>40)throw"ArgumentException";return Version.VERSIONS[d-1]},Version.getProvisionalVersionForDimension=function(d){if(1!=d%4)throw"Error getProvisionalVersionForDimension";try{return Version.getVersionForNumber(d-17>>2)}catch(a){throw"Error getVersionForNumber"}},Version.decodeVersionInformation=function(d){for(var a=4294967295,c=0,b=0;b<Version.VERSION_DECODE_INFO.length;b++){var e=Version.VERSION_DECODE_INFO[b];if(e==d)return this.getVersionForNumber(b+7);e=FormatInformation.numBitsDiffering(d,e),a>e&&(c=b+7,a=e)}return 3>=a?this.getVersionForNumber(c):null},PerspectiveTransform.quadrilateralToQuadrilateral=function(d,a,c,b,e,g,f,h,j,k,n,l,s,r,m,q){return d=this.quadrilateralToSquare(d,a,c,b,e,g,f,h),this.squareToQuadrilateral(j,k,n,l,s,r,m,q).times(d)},PerspectiveTransform.squareToQuadrilateral=function(d,a,c,b,e,g,f,h){return dy2=h-g,dy3=a-b+g-h,0==dy2&&0==dy3?new PerspectiveTransform(c-d,e-c,d,b-a,g-b,a,0,0,1):(dx1=c-e,dx2=f-e,dx3=d-c+e-f,dy1=b-g,denominator=dx1*dy2-dx2*dy1,a13=(dx3*dy2-dx2*dy3)/denominator,a23=(dx1*dy3-dx3*dy1)/denominator,new PerspectiveTransform(c-d+a13*c,f-d+a23*f,d,b-a+a13*b,h-a+a23*h,a,a13,a23,1))},PerspectiveTransform.quadrilateralToSquare=function(d,a,c,b,e,g,f,h){return this.squareToQuadrilateral(d,a,c,b,e,g,f,h).buildAdjoint()};var FORMAT_INFO_MASK_QR=21522,FORMAT_INFO_DECODE_LOOKUP=[[21522,0],[20773,1],[24188,2],[23371,3],[17913,4],[16590,5],[20375,6],[19104,7],[30660,8],[29427,9],[32170,10],[30877,11],[26159,12],[25368,13],[27713,14],[26998,15],[5769,16],[5054,17],[7399,18],[6608,19],[1890,20],[597,21],[3340,22],[2107,23],[13663,24],[12392,25],[16177,26],[14854,27],[9396,28],[8579,29],[11994,30],[11245,31]],BITS_SET_IN_HALF_BYTE=[0,1,1,2,1,2,2,3,1,2,2,3,2,3,3,4];FormatInformation.numBitsDiffering=function(d,a){return d^=a,BITS_SET_IN_HALF_BYTE[15&d]+BITS_SET_IN_HALF_BYTE[15&URShift(d,4)]+BITS_SET_IN_HALF_BYTE[15&URShift(d,8)]+BITS_SET_IN_HALF_BYTE[15&URShift(d,12)]+BITS_SET_IN_HALF_BYTE[15&URShift(d,16)]+BITS_SET_IN_HALF_BYTE[15&URShift(d,20)]+BITS_SET_IN_HALF_BYTE[15&URShift(d,24)]+BITS_SET_IN_HALF_BYTE[15&URShift(d,28)]},FormatInformation.decodeFormatInformation=function(d){var a=FormatInformation.doDecodeFormatInformation(d);return null!=a?a:FormatInformation.doDecodeFormatInformation(d^FORMAT_INFO_MASK_QR)},FormatInformation.doDecodeFormatInformation=function(d){for(var a=4294967295,c=0,b=0;b<FORMAT_INFO_DECODE_LOOKUP.length;b++){var e=FORMAT_INFO_DECODE_LOOKUP[b],g=e[0];if(g==d)return new FormatInformation(e[1]);g=this.numBitsDiffering(d,g),a>g&&(c=e[1],a=g)}return 3>=a?new FormatInformation(c):null},ErrorCorrectionLevel.forBits=function(d){if(0>d||d>=FOR_BITS.Length)throw"ArgumentException";return FOR_BITS[d]};var L=new ErrorCorrectionLevel(0,1,"L"),M=new ErrorCorrectionLevel(1,0,"M"),Q=new ErrorCorrectionLevel(2,3,"Q"),H=new ErrorCorrectionLevel(3,2,"H"),FOR_BITS=[M,L,H,Q];DataBlock.getDataBlocks=function(d,a,c){if(d.length!=a.TotalCodewords)throw"ArgumentException";var b=a.getECBlocksForLevel(c);c=0;var e=b.getECBlocks();for(a=0;a<e.length;a++)c+=e[a].Count;c=Array(c);for(var g=0,f=0;f<e.length;f++){var h=e[f];for(a=0;a<h.Count;a++){var j=h.DataCodewords,k=b.ECCodewordsPerBlock+j;c[g++]=new DataBlock(j,Array(k))}}for(a=c[0].codewords.length,e=c.length-1;e>=0&&c[e].codewords.length!=a;)e--;for(e++,b=a-b.ECCodewordsPerBlock,a=h=0;b>a;a++)for(f=0;g>f;f++)c[f].codewords[a]=d[h++];for(f=e;g>f;f++)c[f].codewords[b]=d[h++];for(j=c[0].codewords.length,a=b;j>a;a++)for(f=0;g>f;f++)c[f].codewords[e>f?a:a+1]=d[h++];return c},DataMask={forReference:function(d){if(0>d||d>7)throw"System.ArgumentException";return DataMask.DATA_MASKS[d]}},DataMask.DATA_MASKS=[new DataMask000,new DataMask001,new DataMask010,new DataMask011,new DataMask100,new DataMask101,new DataMask110,new DataMask111],GF256.QR_CODE_FIELD=new GF256(285),GF256.DATA_MATRIX_FIELD=new GF256(301),GF256.addOrSubtract=function(d,a){return d^a},Decoder={},Decoder.rsDecoder=new ReedSolomonDecoder(GF256.QR_CODE_FIELD),Decoder.correctErrors=function(d,a){for(var c=d.length,b=Array(c),e=0;c>e;e++)b[e]=255&d[e];c=d.length-a;try{Decoder.rsDecoder.decode(b,c)}catch(g){throw g}for(e=0;a>e;e++)d[e]=b[e]},Decoder.decode=function(d){var a=new BitMatrixParser(d);d=a.readVersion();for(var c=a.readFormatInformation().ErrorCorrectionLevel,a=a.readCodewords(),a=DataBlock.getDataBlocks(a,d,c),b=0,e=0;e<a.Length;e++)b+=a[e].NumDataCodewords;for(var b=Array(b),g=0,f=0;f<a.length;f++){var e=a[f],h=e.Codewords,j=e.NumDataCodewords;for(Decoder.correctErrors(h,j),e=0;j>e;e++)b[g++]=h[e]}return new QRCodeDataBlockReader(b,d.VersionNumber,c.Bits)},qrcode={imagedata:null,width:0,height:0,qrCodeSymbol:null,debug:!1,sizeOfDataLengthInfo:[[10,9,8,8],[12,11,16,10],[14,13,16,12]],callback:null,decode:function(d){if(0==arguments.length){var a=document.getElementById("qr-canvas"),c=a.getContext("2d");return qrcode.width=a.width,qrcode.height=a.height,qrcode.imagedata=c.getImageData(0,0,qrcode.width,qrcode.height),qrcode.result=qrcode.process(c),null!=qrcode.callback&&qrcode.callback(qrcode.result),qrcode.result}var b=new Image;b.onload=function(){var a=document.createElement("canvas"),c=a.getContext("2d"),d=document.getElementById("out-canvas");null!=d&&(d=d.getContext("2d"),d.clearRect(0,0,320,240),d.drawImage(b,0,0,320,240)),a.width=b.width,a.height=b.height,c.drawImage(b,0,0),qrcode.width=b.width,qrcode.height=b.height;try{qrcode.imagedata=c.getImageData(0,0,b.width,b.height)}catch(h){return qrcode.result="Cross domain image reading not supported in your browser! Save it to your computer then drag and drop the file!",void(null!=qrcode.callback&&qrcode.callback(qrcode.result))}try{qrcode.result=qrcode.process(c)}catch(j){console.log(j),qrcode.result="error decoding QR Code"}null!=qrcode.callback&&qrcode.callback(qrcode.result)},b.src=d},decode_utf8:function(d){return decodeURIComponent(escape(d))},process:function(d){var a=(new Date).getTime(),c=qrcode.grayScaleToBitmap(qrcode.grayscale());if(qrcode.debug){for(var b=0;b<qrcode.height;b++)for(var e=0;e<qrcode.width;e++){var g=4*e+4*b*qrcode.width;qrcode.imagedata.data[g]=0,qrcode.imagedata.data[g+1]=0,qrcode.imagedata.data[g+2]=c[e+b*qrcode.width]?255:0}d.putImageData(qrcode.imagedata,0,0)}for(c=new Detector(c).detect(),qrcode.debug&&d.putImageData(qrcode.imagedata,0,0),c=Decoder.decode(c.bits).DataByte,d="",b=0;b<c.length;b++)for(e=0;e<c[b].length;e++)d+=String.fromCharCode(c[b][e]);return a=(new Date).getTime()-a,console.log(a),qrcode.decode_utf8(d)},getPixel:function(d,a){if(qrcode.width<d)throw"point error";if(qrcode.height<a)throw"point error";return point=4*d+4*a*qrcode.width,p=(33*qrcode.imagedata.data[point]+34*qrcode.imagedata.data[point+1]+33*qrcode.imagedata.data[point+2])/100},binarize:function(d){for(var a=Array(qrcode.width*qrcode.height),c=0;c<qrcode.height;c++)for(var b=0;b<qrcode.width;b++){var e=qrcode.getPixel(b,c);a[b+c*qrcode.width]=d>=e?!0:!1}return a},getMiddleBrightnessPerArea:function(d){for(var a=Math.floor(qrcode.width/4),c=Math.floor(qrcode.height/4),b=Array(4),e=0;4>e;e++){b[e]=Array(4);for(var g=0;4>g;g++)b[e][g]=[0,0]}for(e=0;4>e;e++)for(g=0;4>g;g++){b[g][e][0]=255;for(var f=0;c>f;f++)for(var h=0;a>h;h++){var j=d[a*g+h+(c*e+f)*qrcode.width];j<b[g][e][0]&&(b[g][e][0]=j),j>b[g][e][1]&&(b[g][e][1]=j)}}for(d=Array(4),a=0;4>a;a++)d[a]=Array(4);for(e=0;4>e;e++)for(g=0;4>g;g++)d[g][e]=Math.floor((b[g][e][0]+b[g][e][1])/2);return d},grayScaleToBitmap:function(d){for(var a=qrcode.getMiddleBrightnessPerArea(d),c=a.length,b=Math.floor(qrcode.width/c),e=Math.floor(qrcode.height/c),g=Array(qrcode.height*qrcode.width),f=0;c>f;f++)for(var h=0;c>h;h++)for(var j=0;e>j;j++)for(var k=0;b>k;k++)g[b*h+k+(e*f+j)*qrcode.width]=d[b*h+k+(e*f+j)*qrcode.width]<a[h][f]?!0:!1;return g},grayscale:function(){for(var d=Array(qrcode.width*qrcode.height),a=0;a<qrcode.height;a++)for(var c=0;c<qrcode.width;c++){var b=qrcode.getPixel(c,a);d[c+a*qrcode.width]=b}return d}},Array.prototype.remove=function(d,a){var c=this.slice((a||d)+1||this.length);return this.length=0>d?this.length+d:d,this.push.apply(this,c)};var MIN_SKIP=3,MAX_MODULES=57,INTEGER_MATH_SHIFT=8,CENTER_QUORUM=2;qrcode.orderBestPatterns=function(d){function a(b,a){return xDiff=b.X-a.X,yDiff=b.Y-a.Y,Math.sqrt(xDiff*xDiff+yDiff*yDiff)}var c=a(d[0],d[1]),b=a(d[1],d[2]),e=a(d[0],d[2]);b>=c&&b>=e?(b=d[0],c=d[1],e=d[2]):e>=b&&e>=c?(b=d[1],c=d[0],e=d[2]):(b=d[2],c=d[0],e=d[1]);var g=b.x,f=b.y;0>(e.x-g)*(c.y-f)-(e.y-f)*(c.x-g)&&(g=c,c=e,e=g),d[0]=c,d[1]=b,d[2]=e},function(d){d.fn.html5_qrcode=function(a,c,b){var e=this.height(),g=this.width();null==e&&(e=250),null==g&&(g=300);var f='<canvas id="qr-canvas" width="'+(g-2)+'px" height="'+(e-2)+'px" style="display:none;"></canvas>';this.append('<video id="html5_qrcode_video" width="'+g+'px" height="'+e+'px"></video>'),this.append(f);var j,h=d("#html5_qrcode_video").get(0);d("#qr-canvas").each(function(a,b){j=b.getContext("2d")});var k=function(){if(localMediaStream){j.drawImage(h,0,0,307,250);try{qrcode.decode()}catch(a){c(a)}setTimeout(k,500)}else setTimeout(svan,500)};window.URL=window.URL||window.webkitURL||window.mozURL||window.msURL,navigator.getUserMedia=navigator.getUserMedia||navigator.webkitGetUserMedia||navigator.mozGetUserMedia||navigator.msGetUserMedia,e=function(a){h.src=window.URL&&window.URL.createObjectURL(a)||a,localMediaStream=a,h.play(),setTimeout(k,1e3)},navigator.getUserMedia?navigator.getUserMedia({video:!0},e,b):console.log("Native web camera streaming (getUserMedia) not supported in this browser."),qrcode.callback=a}}(jQuery);